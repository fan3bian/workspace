	...
	<body>
		...
		<script type="text/javascript" charset="utf-8">
			$(function(){
				...
				resoursequery_datagrid2 = $('#dg2').datagrid({
					url:'${pageContext.request.contextPath}/homepage/queryOrder.do',
					queryParams: {
						type: '2',
							sort: 'ctime',
							order: 'desc'
					...
					onClickRow:function(rowIndex,rowData){
						window.parent.window.parent.querymenu('%/workOrderMg/OrderSearch.jsp%');
					},
					columns:[[{
						title:'序号',
						field:'rmdid',
	...
	function translateDate(value){
		...
		return time;
			...
			<div data-options="region:'center',border:false" style="background:#eee;">
				<table id="dg2" style="background:#eee;width:100%;text-align:center;"></table>
			</div>
		</div>
	</body>
</html>
