	...
	<div data-options="region:'center',border:false" id="resourcesid">
		...
		<table title="" style="width:100%;" id="DisasterOverviewDataGrid">
			...
			<tr>
				...
				<th data-options="field:'clientName'" >备份机器名称</th>
				<th data-options="field:'interfacename',width:60,align:'center'">备份机器IP</th>
				<th data-options="field:'osname',width:40,align:'center',sortable:true">操作系统</th>
				<th data-options="field:'idataagent',width:40,align:'center',sortable:true">备份类型</th>
			...
			<%--	<th data-options="field:'enddate',width:100,align:'center'" >结束时间</th>
					...
					<th data-options="field:'incrlevel',align:'center',sortable:true" formatter="increaseFormatter">是否增量备份</th>--%>
				<th data-options="field:'numbytesuncomMB',align:'center',width:100,sortable:true">备份容量(MB)</th>
			</tr>
			</thead>
		</table>
	</div>
...
//			_data[2] = boughtnum;
		...
		function loadDataGrid() {
			...
			var _datagrid = $('#DisasterOverviewDataGrid').datagrid({
				...
				pageNumber:1,
				pageList: [5,10,20,30],
				url: '${pageContext.request.contextPath}/report/getBakDetailYear.do',
