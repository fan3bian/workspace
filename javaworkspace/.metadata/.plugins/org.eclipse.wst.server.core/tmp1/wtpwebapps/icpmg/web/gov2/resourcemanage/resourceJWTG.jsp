            ...
            <div class="ty-tabscon-main">
                <div class="ty-tabscon-item">
                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="ty-tabcon-table-layout">
                        <tr>
                           <!--  <td align="right" width="16%"> <span class="must-star">*</span>业务应用系统：</td>
                            <td align="left" width="34%">
                                  <input id="u_ywyyxt" type="text" class="ty-top-input" style="width: 168px;">
                            </td> -->
                        ...
                        <tr>
                            ...
                            <td align="left">
                                <input class="j-datetimebox"  style="width:180px;line-height: 30px" id="u_putime">
                            </td>
                         <!--    <td align="right">域名备案：</td>
                            <td align="left">
                                <ul class="ty-tabscon-item-ul j-item-ul">
                           ...
                           <td align="left">
                                    <input id="u_jg_beianquyu" type="text" class="ty-top-input" style="width: 168px;">
                            </td>
                            <td align="right">托管类型：</td>
                            <td align="left">
                                <input id="u_jg_tuoglx" type="text" class="ty-top-input" style="width: 168px;">
                            </td>
                        </tr>
                        <tr>
                          <!--   <td align="right"> <span class="must-star">*</span>网络设备：</td>
                ...
                <div class="ty-tabscon-item">
                    ...
                    <div style="height: 200px; overflow:auto;">
                        <table id="positionManagedtt" style="width:740px;height:auto" data-options="fitColumns:false,rownumbers: true,border: false,singleSelect:true,url:'',scrollbarSize:0">
                         <thead>
                                <tr>
  ...
  <script type="text/javascript">
        ...
        $.ajax({
			  ...
			  success:function(retr){
	           ...
	           $("#u_jg_beianquyu").val(retr.recordregion);
		       $("#u_jg_tuoglx").val(retr.cabinettype);
