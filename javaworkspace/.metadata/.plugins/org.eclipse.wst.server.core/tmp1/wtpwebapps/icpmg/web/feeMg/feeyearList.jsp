                    ...
                    <div style="margin: 5px 20px;">
                        <table class="lcy-search">
                            <tr>
                                ...
                                <!-- <input class="easyui-textbox" id="tdate" name="tdate" style="height: 30px; ">  -->                            
    ...
    $('#tdate').combobox('yearandmonth');
	    ...
	    $(document).ready(function() {	    	        
            ...
            $('#order_dg').datagrid({
                ...
                url: '${pageContext.request.contextPath}/scoreinfoMg/feeyearList.do', 
                 toolbar: [            
                /* {
                    id: 'almexp',
                    text: '导出',
              	...
              	onLoadSuccess: function (data) {
              	  ...
              	  document.getElementById("sum").innerHTML=data.yearPrice;
            ...
            var feeyearTotal = "<div id='addtoolbar'>当前费用总和：<span style='color:#f00' id='sum'></span>元</div>";
			$(".datagrid-toolbar table").css("float","left");
			$(".datagrid-toolbar").append(feeyearTotal);
    });
