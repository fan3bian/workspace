	...
	<div data-options="region:'center',border:false" id="resourcesid">
		...
		<table title="" style="width:100%;" id="DisasterOverviewDataGrid">
			...
			<tr>
				...
				<th data-options="field:'clientname',width:60,align:'center'">备份机器IP</th>
				<th data-options="field:'osname',width:100,align:'center',sortable:true">操作系统</th>
				<th data-options="field:'idataagent',width:100,align:'center',sortable:true" formatter="idataagentFormatter">备份类型</th>
...
//							{ itemid: '<div style="text-align:center;color:red">没有相关记录！</div>' }
	...
	function idataagentFormatter(value,row,index){

		if("unknown" == value) {
			return row[index]['clientname']
		}else{
			return value;
		}
