...
<head>
	...
	<script type="text/javascript">
	  ...
	  location.href ="lession_"+page+".html";
   }
		...
		<div class="container">
			...
			<div class="container-left">
				<div class="inside-menu">
					<ul>
						<li><a class='active' href="../lession/lession_1.html">新手课堂</a></li>
			...
			<div class="container-right">
				...
				<div class="container-cell">
					<#if page??>
					    <#list page as lession>
					<div class="inner-service">
						<dl class="cf">
						 
							<dt><img src="../../../images/up${lession.lessionimage}" alt="inspur" width="233px" height="163px"></dt>
							<dd>
								<h2>${lession.lessiontitle}</h2>
								<p><a href="../../content/lession/lession_${lession.lessionid}.html" class="infor${lession_index}">${lession.lessionintroduce}</a></p>
								<a href="../../content/lession/lession_${lession.lessionid}.html" class="more">点击查看 +</a>
							</dd>
						</dl>
						<script type="text/javascript">
	               $(function(){
	
	                var text=  $(".infor${lession_index}").text();
                
                      if(text.length>100){
                         $(".infor${lession_index}").text(text.substring(0,100)+"...");
                         }
