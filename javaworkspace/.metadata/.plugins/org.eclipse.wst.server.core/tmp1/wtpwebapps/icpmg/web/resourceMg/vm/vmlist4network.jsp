...
function optionformater(value, row, index) {
	if(null == value || "" == value){
		...
		return "<a href=\"javascript:void(0);\" onclick=\"createDialog1(\'" + row.imode + "\', \'" + row.uuid + "\', \'" + row.interbw + "\', \'" + row.interport + "\', \'" + row.detailid + "\', \'" + row.cuserid+ "\', \'" + row.flowid + "\', \'" + row.detailid  + "\');\">网络配置</a>";
	}else if('5' == value){
		return "请稍候";
	}else if('-1' == value){
...
function createDialog1(imode, serverid, interbw, interport, detailid,serveruserid,flowid,detailid){
    ...
    jQuery.ajax( {
        ...
        success : function(data) {
			var result = eval("("+data.msg+")");
             console.info(result);
             console.info(result.intraip);
//			"{"flowid":"BFO-20151012-00001","orderid":"0000000594","detailid":"1","vlanid":"测试","netseg":"172.168.1.1/25","intermode":"",
// "interbw":"联通:1;移动:0;电信:0;","interport":"联通:1000;移动:;电信:;","intraip":"192.168.1.1",
// "username":"root","password":"123456","curstat":"1","cuserid":"sysnet","ctime":"2015-10-12 13:08:24","snote":""}"

//			13:08:24"
//			curstat: "1"
//			cuserid: "sysnet"
//			detailid: "1"
//			flowid: "BFO-20151012-00001"
//			interbw: "联通:1;移动:0;电信:0;"
//			intermode: ""
//			interport: "联通:1000;移动:;电信:;"
//			intraip: "192.168.1.1"
//			netinfomobile: "192.168.1.1:,192.168.1.1:192.168.1.1"
//			netinfotelecom: "192.168.1.1:,192.168.1.1:192.168.1.1"
//			netinfounicom: "192.168.1.1:,192.168.1.1:192.168.1.1"
//			netseg: "172.168.1.1/25"
//			orderid: "0000000594"
//			password: "123456"
//			snote: ""
//			username: "root"
...
<div id="w2" class="easyui-window" title="云服务器销毁" data-options="closed:true,minimizable:false,maximizable:false,closable:false,iconCls:'icon-save',inline:true" style="width:500px;height:200px;padding:5px;">
	<div class="easyui-layout" data-options="fit:true">
		<div data-options="region:'center'" style="padding:10px;">
			...
			<input type="hidden" id="serverid2_" name="serverid2_"/>
			<input type="hidden" id="detailid2_" name="detailid2_"/>
			<input type="hidden" id="serveruserid2_" name="serveruserid2_"/>
