...
<link rel="stylesheet" type="text/css" href="<%=path%>/css/workOrder/workorder.css"/>
	...
	<div id="tabs" class="easyui-tabs" style="width:100%;height:100%background:#eee" data-options="tabWidth:112, border:false" >
		...
		<%
		     ...
		     %>	          
		    <tr>
				<td  class="FieldLabel2" style="border-top:none !important;" ><%=fieldname %> <font color="red">(不得超过256个字符)</font></td>
	...
	<div id="tabs-2" title="处理" data-options="selected:true" style="padding:10px;background:#eee">
		...
		<table class="wotable" width="93%" align="center" >
			...
			<table class="wotable" width="93%" align="center" >		
			<tr>
				<td  class="FieldLabel2" style="border-top:none !important;" >处理备注<font color="red">(不得超过256个字符)</font></td>
				<td class="FieldInput2" style="border-top:none !important;" ><textarea rows="5" cols="100" type="text" name="comments" id="comments" style="overflow-y:scroll" ></textarea></td>
			</tr>
...
//				cstatus,cstatusname
		  ...
		  <div title='<span style="color: #fff;font-size:15px">
			...
			%>		
			<tr>
				<td  class="FieldLabel2" style="border-top:none !important;" >处理备注</td>
				<td class="FieldInput2" style="border-top:none !important;" ><textarea rows="5"  cols="100" style="border:none !important;background:none !important;overflow-y:scroll" readonly="readonly" type="text" name="comments" field="comments" ><%=snote %></textarea></td>
			</tr>
		</table>
			</div>	
		    <%
	 ...
	 function operTypeFormater(value,row,index){
	    ...
	    function detailsformater(value,row,index)
		 ...
		 if('200012'==row.shopid){
		  ...
		  if('200061'==row.shopid){
		    
		     return icp.formatString('<a style=\"color:blue;cursor:pointer\" onclick=\"viewFWDetails(\'{0}\',\'{1}\');\">详情</a>', row.detailid,row.orderid);
		 ...
		 function viewFWDetails(detailid,orderid){
	        var url="${pageContext.request.contextPath}/web/ordersMg/orderFW.jsp?orderid="+orderid+"&detailid="+detailid;
	     	var dialog = parent.icp.modalDialog({
			title : '防火墙详情一览',
			width:'700px',
			height: '340px',
