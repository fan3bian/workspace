...
$('#dd').dialog('open');
	...
	<div id="tabs" class="easyui-tabs" style="width:100%;background:#eee" data-options="tabWidth:112, border:false" >
       ...
       %>
		...
		<%
		  ...
		  <div title=' <span style="color: #fff;font-size:15px">
		  	<%=i+1 %>.&nbsp;&nbsp;&nbsp;工单环节：<%=stepname %>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 处理人:<%=cusername %>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;处理时间:<%= ctime%></span>' icon="icon-ok" style="overflow:auto;padding:10px;" >
