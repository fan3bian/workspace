...
//	var nename = '7b363fee-4045-4371-8318-be59bdfd8520';
	...
	var osinserver_usage_action = context_path + "/os_inserver_runoverview/getOSInserverUseage.do";

/**************************************************************************************************
 * cpu利用率图表
 */		
	var cpuGaugeChart = echarts.init(document.getElementById('osinserver-cpu-zone'));
	var cpuGaugeOption = {
		    tooltip : {
		        formatter: "{a}: {c}%"
		    },
 ...
 * 内存利用率图表
 */		
	var memGaugeChart = echarts.init(document.getElementById('osinserver-mem-zone'));
	var memGaugeOption = {
		    tooltip : {
		        formatter: "{a}: {c}%"
		    },
