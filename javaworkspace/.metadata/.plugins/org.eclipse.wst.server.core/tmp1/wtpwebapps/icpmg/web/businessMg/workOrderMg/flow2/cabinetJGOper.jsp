 ...
 <!-- 整机柜托管 -->
        ...
        <div class="j-tabs-con">
            <div class="ty-tabscon-main">
                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="ty-tabcon-table-layout">
                        <tr>
                            ...
                            <td align="left" width="34%">
                                 <input id="ywyyxt" type="text" class="ty-top-input" style="width: 180px;" readonly="readonly">
                            </td> -->
                        ...
                        <tr>
                            ...
                            <td align="left">
                                <input class="ty-top-input"  style="width:180px" id="zjtg_sjsj">
                            </td>
                            <!-- <td align="right">域名备案：</td>
                            <td align="left">
                                <ul class="ty-tabscon-item-ul j-item-ul">
                        ...
                        <tr>
                           ...
                           <td align="left">
                                    <input id="jg_beianquyu" type="text" class="ty-top-input" style="width: 180px;">
                            </td>
                            <td align="right">托管类型：</td>
                            <td align="left">
                                <input id="jg_tuoglx" type="text" value="机柜" class="ty-top-input" style="width: 180px;" readonly="readonly">
                            </td>
                        </tr>
                        <tr>
                          <!--   <td align="right"> <span class="must-star">*</span>网络设备：</td>
                            ...
                            <td align="left">
                                <input id="jg_power" type="text" class="ty-top-input" style="width: 180px;">
                            </td>
                        </tr>
                        <tr>
                          <!--   <td align="right">机柜功率：</td>
                            ...
                            <td align="left">
                                <input id="jg_num" type="text" class="ty-top-input" style="width: 180px;">
                            </td>
                             <td align="right">分配机柜：</td>
                            <td align="left">
                                <input id="jg_opernote" type="text" class="ty-top-input" style="width: 180px;">
                            </td>
                        </tr>
                        <!--  <tr>
                            <td align="right">分配机柜：</td>
                ...
                <div class="ty-tabscon-item">
                    ...
                    <div style="height: 185px; overflow-x:hidden;overflow-y:auto;">
                        <table id="boxManagedWindowtt" style="width:100%;height:auto" data-options="fitColumns:false,rownumbers: true,border: false,singleSelect:true,scrollbarSize:0">
                            <thead>
                                <tr>
                           ...
                           type: 'validatebox',
                            options:{required:true  }
                                    ...
                                    <th data-options="field:'equipmentpro',width:110,align:'left',editor:{type:'validatebox'}">品牌型号</th>
    ...
    var optionTypes = [{
	   ...
	   var submitSave = function($dialog, $row,$stepsno,$flowsid){
		       ...
		       if(''==$("#jg_beianquyu").val() && "是"==$("#boxManagedWindow .ty-tabscon-item-ul").eq(1).find("li.active").text()){
               $.messager.alert('消息',"请填写备案号","info");
                return;
              }
              var opernote = $('#jg_opernote').val();
              if(''==opernote){
                  opernote=' ';
              }
              var cabis=[];
             ...
             if(isendEdit("boxManagedWindowtt",eqipments)){
                ...
                eqipments= $("#boxManagedWindowtt").datagrid('getRows');
             }else{
       ...
       /*         var configure="";var appid_zjtg="";var appname_zjtg=""; var jg_num=""; var putaway="";
               ...
               cabinet.recordregion = $("#jg_beianquyu").val();
               cabinet.cabinettype = $("#jg_tuoglx").val();                
	          /*  cabinet.appid = $row.appid;
	           cabinet.appname = $row.appname; */
               cabinet.cabinetnum = $("#jg_num").val();
               cabinet.putawaytime=$("#zjtg_sjsj").val();
        ...
        $('#jg_beianquyu').val('');
       <%--  $("#boxManagedWindow #ywyyxt").val('<%=appname%>'); --%>
        // 弹层内容easyui初始化
        ...
        $.ajax({
			  ...
			  success:function(retr){
		       ...
		       $('#zjtg_sjsj').val(retr.putawaytime);
               $("#jg_num").val(retr.cabinetnum);
               $("#jg_power").val(retr.cabinetpower);
        ...
        $('#boxManagedWindowtt').datagrid({
            ...
            onClickRow: function(rowIndex) {
             ...
             onLoadSuccess: function() {
                 ...
                 var len = $('#boxManagedWindowtt').datagrid('getRows').length;
                if(len>0){
                    $('#boxManagedWindowtt').datagrid('selectRow', 0);
                    $('#boxManagedWindowtt').datagrid('beginEdit', 0);
                }   
            }
        });
	  //托管开始
      $(document).on('click', '.j-item-ul li', function(event) {
        ...
        if("是" === $("#boxManagedWindow .ty-tabscon-item-ul").eq(1).find("li.active").text()){
             $('.must-beianhao').show();
        }else{
             $(".must-beianhao").hide();
        }
...
function resizeGrid(){
    $('#boxManagedWindowtt').datagrid('resize');
}
      </script>
  </body>
</html>
