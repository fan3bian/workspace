...
.table-yy input{ width:100%}
            ...
            <div class="ty-tabscon-main">
                <div class="ty-tabscon-item">
                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="ty-tabcon-table-layout">
                        <tr>
                           <!--  <td align="right" width="16%"> <span class="must-star">*</span>业务应用系统：</td>
                            <td align="left" width="34%">
                                 <input id="ywyyxt" type="text" class="ty-top-input" style="width: 168px;">
                            </td> -->
                        ...
                        <tr>
                            ...
                            <td align="left">
                                <input class="j-datetimebox"  style="width:180px" id="zjtg_sjsj">
                            </td>
                          <!--   <td align="right">域名备案：</td>
                            <td align="left">
                                <ul class="ty-tabscon-item-ul j-item-ul">
                        ...
                        <tr>
                           <td align="right"> <span class="must-star">*</span>备案号：</td>
                           <td align="left">
                                    <input id="jg_beianquyu" type="text" class="ty-top-input" style="width: 168px;">
                            </td>
                            <td align="right">托管类型：</td>
                            <td align="left">
                                <input id="jg_tuoglx" type="text" class="ty-top-input" style="width: 168px;">
                            </td>
                        </tr>
                        <tr>
                          <!--   <td align="right"> <span class="must-star">*</span>网络设备：</td>
                            ...
                            <td align="left">
                                <input id="jg_power" type="text" class="ty-top-input" style="width: 168px;">
                            </td>
                        </tr>
                        <tr>
                         <!--    <td align="right">机柜功率：</td>
                            ...
                            <td align="right">申请机柜个数：</td>
                            <td align="left">
                                <input id="jg_num" type="text" class="ty-top-input" style="width: 168px;">
                            </td>
                                <td align="right">分配机柜：</td>
                            <td align="left">
                                <input id="jg_opernote" type="text" class="ty-top-input" style="width: 168px;">
                            </td>
                        </tr>
                          <!-- <tr>
                            <td align="right">分配机柜：</td>
                ...
                <div class="ty-tabscon-item">
                    ...
                    <div style="height: 200px; overflow:auto;">
                        <table id="boxManagedWindowtt" style="width:740px;height:auto" data-options="fitColumns:false,rownumbers: true,border: false,singleSelect:true,scrollbarSize:0">
                            <thead>
                                <tr>
                           ...
                           type: 'validatebox',
                            options:{required:true  }
                                    ...
                                    <th data-options="field:'equipmentpro',width:100,editor:{type:'numberbox', options:{required:true  }}"> 品牌型号</th>
                        ...
                        editor:{
                            ...
                            options:{
                                ...
                                <th data-options="field:'equipmentcode',width:90,editor:{type:'validatebox', options:{required:true  }}">序列号</th>
	                           ...
	                           editor:{
	                            type: 'combobox'
                                   ...
                                   <span class="must-star">*</span>应用</th>
                                      <th data-options="field:'cabinetnumber',width:120,editor:{type:'validatebox',options:{required:true}}"><span class="must-star">*</span>上架机柜号</th>
                                      <th data-options="field:'unumber',width:100,editor:{type:'validatebox',options:{required:true}}"><span class="must-star">*</span>上架U位</th>
  ...
  <script type="text/javascript">
        ...
        $.ajax({
              ...
              type:'post',
			  url:'${ctx}/workorder/getCabinetsOper.do?objectid=<%=request.getParameter("objectid")%>',
			  async: false,//使用同步的方式,true为异步方式
			  dataType:'json',
			  success:function(retr){
			    
		       $('.j-datetimebox').datebox('setValue',retr.putawaytime);
               $("#jg_num").val(retr.cabinetnum);
               $("#jg_opernote").val(retr.opernote=='null'?'':retr.opernote);
               $("#jg_power").val(retr.cabinetpower=='null'?'':retr.cabinetpower);
		       $("#jg_beianquyu").val(retr.recordregion);
		       $("#jg_tuoglx").val(retr.cabinettype);
                if(retr.putaway=="浪潮协助上架")
			    {
			        $("#boxManagedWindow .ty-tabscon-item-ul ").eq(0).find("li").eq(0).addClass('active').siblings().removeClass('active');
			    }
			    else
			    {
			        $("#boxManagedWindow .ty-tabscon-item-ul ").eq(0).find("li").eq(1).addClass('active').siblings().removeClass('active');
			    }
			      if(retr.domainrecord=="是")
			    {
			        $("#boxManagedWindow .ty-tabscon-item-ul ").eq(1).find("li").eq(0).addClass('active').siblings().removeClass('active');
			    }
			    else
			    {
			        $("#boxManagedWindow .ty-tabscon-item-ul ").eq(1).find("li").eq(1).addClass('active').siblings().removeClass('active');
			    }
			      if(retr.netmachine=="共享云中心")
			    {
			        $("#boxManagedWindow .ty-tabscon-item-ul ").eq(2).find("li").eq(0).addClass('active').siblings().removeClass('active');
			    }
			    else
			    {
			        $("#boxManagedWindow .ty-tabscon-item-ul ").eq(2).find("li").eq(1).addClass('active').siblings().removeClass('active');
			    }
			      if(retr.safety=="共享云中心")
			    {
			        $("#boxManagedWindow .ty-tabscon-item-ul ").eq(3).find("li").eq(0).addClass('active').siblings().removeClass('active');
			    }
			    else
			    {
			        $("#boxManagedWindow .ty-tabscon-item-ul ").eq(3).find("li").eq(1).addClass('active').siblings().removeClass('active');
			    }
        ...
        $('#boxManagedWindowtt').datagrid({
            url:'${ctx}/workorder/getCabinetEquipOfOper.do?objectid=<%=request.getParameter("objectid")%>',    
    ...
    function productFormatter2(value) {
     ...
     function appFormatters(value) {
          ...
          var appname = value;
         	$.ajax({
			  		async:false,
			  		type : 'post',
			  		url:'${ctx}/ordermg/getAppsById.do?appid='+ value,
			  		dataType:'json',	  	
     ...
     $('#jg_opernote').tooltip({
				position: 'right',
				content: '<span>'+$('#jg_opernote').val()+'</span>',
				onShow: function(){
