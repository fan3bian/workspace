...
<iframe id="reportframe" src="<%=reportRootPath%>/action?obj=query.GotoQueryDetailAction&amp;queryId=<%=reportQueryId%>&amp;operate=View&amp;parentId=<%=reportParentId%>&amp;isPrivate=0&amp;partName=Query" style="width: 100%;height:100%;border:0px"></iframe>			
</div>						
</body>
</html>