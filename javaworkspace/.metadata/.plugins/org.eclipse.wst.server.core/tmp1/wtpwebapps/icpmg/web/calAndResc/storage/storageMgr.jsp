...
<style type="text/css">
	...
	<script type="text/javascript">
		...
		function curStatFormatter (value,row,index){
			...
			var str='' ;
			str += '<a onclick="storageOperMonitor(\''+row.storagename+'\');">运行监控</a>';
			str += '&nbsp;|&nbsp;' ;
			str += curState ;
			return str ;
		}
		...
		//运行监控
		function storageOperMonitor(storagename){
			$('#centerTab').panel({
				href:"${pageContext.request.contextPath}/instance/storageOperMonitor.do?storagename=" + storagename
			});
		}
			...
			<table title="" style="width:100%;"  id="dg">
				<thead>
					<tr>
						...
						<th data-options="field:'storagetotal',width:80,align:'center'">总容量(GB)</th>
						<th data-options="field:'storageleft',width:80,align:'center'">剩余容量(GB)</th>
						<th data-options="field:'storageready',width:80,align:'center'">置备容量(GB)</th>
