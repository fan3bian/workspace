...
<body>
   <div id="securityServiceOpen_successEW" class="easyui-window" title="安全服务开通-创建成功" data-options="iconCls:'icon-add',closed:true,modal:true,collapsible:false,minimizable:false,maximizable:false" style="width:814px;height:330px;">
	  <div class="createInstances_flow"> 	
		<img alt="step1" src="${pageContext.request.contextPath}/web/security/image/security_ew_flow_02.png" />
	  </div>	
	   <div class="createInstancesEW_success_wrap" style="width: 100%;height: 180px; overflow: hidden;">
	   ...
	   <div class="security_detail_basic_wrapEW">
	     ...
	     <div class="security_detail_basic_th2">
	       ...
	       <div class="security_detail_text">描述</div>
	       <div class="security_detail_text">数量</div>
	     </div>
	     <div class="security_detail_basic_th3">
	       <div class="security_detail_text_th3" id="security_detail_text_suseridEW"></div>
	       <div class="security_detail_text_th3" id="security_detail_text_displaynameEW"></div>
	       <div class="security_detail_text_th3" id="security_detail_text_descriptionEW"></div>
	       <div class="security_detail_text_th3" id="security_detail_text_numEW"></div>
	     </div>
	 ...
	 <div style="background-color: #dce0e4;padding: 6px;text-align:center; clear: both;">
	   ...
	   <a href="javascript:void(0);" class="easyui-linkbutton" data-options="iconCls:'icon-ok',plain:true" onclick="$('#securityServiceOpen_successEW').window('close');">确定</a>
      </div>
   </div>
</body>
</html>
