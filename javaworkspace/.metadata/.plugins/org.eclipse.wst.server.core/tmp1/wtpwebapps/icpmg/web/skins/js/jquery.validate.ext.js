...
//字符验证  ,只能包括中英文、数字、下划线和空格     
jQuery.validator.addMethod("string_space", function(value, element) {       
...
//只能为英文、数字、下划线和逗号字符
jQuery.validator.addMethod("string_nocn_comma", function(value, element) {       
	return this.optional(element) || /^[_,0-9A-Za-z]+$/.test(value);
},"仅限英文、数字、下划线和逗号");
//只能为英文、数字、下划线和空格字符
jQuery.validator.addMethod("string_nocn_space", function(value, element) {       
	return this.optional(element) || /^[_\s0-9A-Za-z]+$/.test(value);
},"仅限英文、数字、下划线和空格");
//只能为英文、下划线字符
...
//只能为数字和点
jQuery.validator.addMethod("string_no_dot", function(value, element) {       
   return this.optional(element) || /^\d+(\.\d+)?$/.test(value);
},"请正确输入版本信息");
//只能为数字
jQuery.validator.addMethod("string_no", function(value, element) {       
...
jQuery.validator.addMethod("isIP", function(value, element){
    return this.optional(element) || /^(([0-1]?\d{1,2}|2[0-4]\d|25[0-5])\.){3}([0-1]?\d{1,2}|2[0-4]\d|25[0-5])$/.test(value);
},"请填写正确的IP地址");
//验证文件路径
jQuery.validator.addMethod("file_path", function(value, element) {       
