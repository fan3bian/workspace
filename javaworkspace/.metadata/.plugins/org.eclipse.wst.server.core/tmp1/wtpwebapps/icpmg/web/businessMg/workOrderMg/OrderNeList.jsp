...
function save(){
		    ...
		    url:'<%=path%>/workorder/saveResourcesServer.do',
		    onSubmit: function(){
		    },
...
(G)</strong></td>
    ...
    <tr>
     ...
     <tr>
      ...
      <td  style="display:none" align="center"><strong>内网端口</strong></td>
    ...
    <tr>
      ...
      <td align="center"><%=str4 %></td>
      <td align="center"><%=str5 %></td>
      <td style="display:none" align="center"><%=str6 %></td>
      <td>
    ...
    <tr>
      ...
      <table width="1000px" border="1" cellpadding="0" cellspacing="0" bordercolor="#999999">
        ...
        <th colspan="3" align="center" bgcolor="#66CCCC" class="bg" scope="col">远程vpn访问信息</th>
          <th colspan="3" align="center" bgcolor="#66CCCC" class="bg" scope="col">FTP配置信息</th>
        </tr>
        <tr>
         ...
         <tr>
          ...
          <td  align="center">
          <input type="text" name="vpnname" id="vpnname" size=5 style="height:25px"/>
         </td>
          <td  align="center">
          <input type="text"  name="vpnpass" id="vpnpass" size=5 style="height:25px"/>
          </td>
          <td  align="center">3085024126@yimihome.com</td>
          <td  align="center">
          <input type="text" name="ftpname" id="ftpname" size=5 style="height:25px"/>
          </td>
          <td  align="center">
          <input type="text"  name="ftppass"  id="ftppass" size=5 style="height:25px"/>
          </td>
