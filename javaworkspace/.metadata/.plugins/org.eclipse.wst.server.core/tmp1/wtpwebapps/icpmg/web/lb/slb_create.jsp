...
function loadObjectDataGrid(){
	...
	function connect() {
		 ...
		 if(window.lbobjects){
			 window.lbobjects.close();
			 window.lbobjects=null;
		 }
	    ...
	    ws.onmessage = function (event) {
	        $('#lb_object_grid').datagrid('reload');
	    };
		...
		<table title="" style="width:100%;" id="object_grid">
			<thead>
				<tr>
					...
					<th data-options="field:'funip',width:50,align:'center',formatter:funip">IP</th>
...
<div hidden><!--设置为hidden防止浏览器加载缓慢，会先显示DOM  -->
<jsp:include page="lbcreat.jsp"></jsp:include>
<jsp:include page="lbcreae_success.jsp"></jsp:include>
</div>
</body>
