(function( $ ){          
    ...
    var settings = {
        ...
        'amount'      :   '5',       
        'onclicktype' :   'all',
        'address'     :   '${pageContext.request.contextPath}/oms_summary/queryHostList.do',
        'format'      :   'json',
    ...
    var methods = {
        ...
        get_data      : function(){   
           // alert('getting data')
            ...
            var type = $("#inhostoverview_searchtype").val();
            var value = $("#inhostoverview_searchvalue").val();
            var name = $("#inhostoverview_searchname").val();
            var onclicktypes = $("#hostonclicktype").val();
             if(type=='1'){
             	variables.last=5;
             	$("#inhostoverview_searchtype").val("0");
             }
