...
<html>
  <head>
    ...
    <title>My JSP 'orderStore.jsp' starting page</title>
  ...
  <body>
            ...
            <div class="ty-tabscon-main">
                <div class="ty-tabscon-item">
                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="ty-tabcon-table-layout" style="table-layout:fixed">
                        ...
                        <tr>
                            <td align="right" style="width:15% ; "> <span class="must-star">*</span>硬盘名称：</td>
                            <td align="left" style="width:40%;">
                                <input class="ty-top-input" name="" id='storename'  style="width:151px" >
                            </td>
                            <td align="right" style="width:15%;"> <span class="must-star">*</span>区域：</td>
                            <td align="left" style="width:35%;">
                                <input class="ty-top-input" name="" id='storeNetWork'  style="width:147px" >
                            </td>
                       	</tr>
                       	<tr>
                       		<td align="right" style="width:15% ; "> <span class="must-star">*</span>硬盘容量：</td>
                            <td align="left" style="width:40%;">
                                <input class="ty-top-input" name="storenum" id='storeNum'  style="width:151px" >
                            </td>
                        </tr>
                        <tr>
                            <td align="right">硬盘描述：</td>
                            <td align="left" colspan="3">
                              <textarea style="height: 90px;width: 473px;border:1px solid #ddd; border-radius: 3px; " id='storeinfo'></textarea>
                            </td>
                        </tr>
                    </table>
                </div>
    ...
    <script type="text/javascript">
    	$.ajax({
    		type:'post',
    		url:'<%=basePath%>/indisk/getStoreDetail.do?orderid='+'<%=request.getParameter("orderid")%>'+'&detailid='+'<%=request.getParameter("detailid")%>',
    		async: false,//使用同步的方式,true为异步方式
		    dataType:'json',
		    success:function(data){
		    	$('#storename').val(data.displayname);
		    	$('#storeNum').val(data.disknum+'G');
		    	$('#storeinfo').val(data.snote);
		    	$('#storeNetWork').val(data.networkname);
		    }
    	});
    </script>
  </body>
