...
<form id="tableform" method="post">
  <table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#999999">
    <tr align="center"class="header">
      <th height="60" colspan="12" bgcolor="#0B52D7" class="header" scope="col">云数据库报价单</th>
    </tr>
    <tr >
      <th colspan="12" align="left" class="bg" scope="col">用户及应用信息</th>
    </tr>
    <tr>
      <td width="15%" rowspan="2" align="center" bgcolor="#66CC99"><strong>服务说明</strong></td>
    ...
    <tr>
      <td  width="5%" align="center"><strong>数据库名称</strong></td>
    <!--   <td width="4%" align="center"><strong>内存大小(G)</strong></td> -->
      <td width="4%" align="center" colspan="2"><strong>硬盘大小(G)</strong></td>
      <td width="4%" align="center"><p><strong>带宽(Mb)</strong></p></td>
      <!-- <td width="7%" align="center"><p><strong>外网接入模式</strong></p></td> -->
      <td width="7%"  align="center" colspan="3"><strong>允许访问ips</strong></td>
    </tr>
     <%
     if(list.size()>0){
        ...
        String str2 = 	String.valueOf(vo1.getDbname());
        ...
        %>
    <tr>
      <td align="center">云数据库服务</td>
      <td align="center"  ><%=vo1.getDbname() %></td>
     <%--  <td align="center"><%=vo1.getMemnum()%></td> --%>
      <td align="center" colspan="2"><%=vo1.getDisknum()%></td>
      <td align="center"><%%></td>
     
      <td align="center" colspan="3"><%=vo1.getIps() %></td>
