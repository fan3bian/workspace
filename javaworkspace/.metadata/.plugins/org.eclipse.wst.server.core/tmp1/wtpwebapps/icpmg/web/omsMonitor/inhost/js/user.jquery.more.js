(function( $ ){          
    ...
    var settings = {
        ...
        'type'           :   '0',
        'onclicktype' :   'all',
        'address'     :   '${pageContext.request.contextPath}/oms_summary/queryInhostUserList.do',
        'format'      :   'json',
    ...
    var methods = {
        ...
        get_data      : function(){   
           // alert('getting data')
            ...
            var type = $("#hostserviceuseroverview_searchtype").val();
            var value = $("#hostserviceuseroverview_searchvalue").val();
            var unitid = $("#hostserveruserneid").val();
            var onclicktypes = $("#inhostuseronclicktype").val();
             if(type=='1'){
             	variables.last=5;
             	$("#hostserviceuseroverview_searchtype").val("0");
             }
