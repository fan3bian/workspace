...
<html>
  ...
  <%  
	...
	%>
  <body>
  		<input type="hidden" id="hostserverdetailneid" value="<%=neid %>"></input>
  		<link rel="stylesheet" href="${pageContext.request.contextPath}/web/omsMonitor/host/css/hostDetails.css" />
  		<link rel="stylesheet" href="${pageContext.request.contextPath}/web/omsMonitor/inhost/css/inhostDetails.css" />
		...
		<script type="text/javascript">
			...
			//查询基本信息
			function queryInhostBasic(){
				var neid = $("#hostserverdetailneid").val();
				//var neid = '42072c81-1e87-4e5d-8097-422f2e042bc4';
				$('#queryHostseverBasic').form(
						'load',
						"${pageContext.request.contextPath}/oms_summary/queryBasicInfo.do?neid="+neid
				);
			};
			//查询告警信息
			function queryInhostAlarm(){
				var neid = $("#hostDetailneid").val();
				$("#hostserviceDetailTable_alarm").bigPage({
					data:null,
					ajaxData:{
	  	...
	  	<form id="queryHostseverBasic" method="post">
	  		<div class="inhostDetails_space top">
	  			...
	  			<div class = "inhostDetails_space_top_o" style="width: 25%;">
	  				<div class="top_3_span">
	  					<div class="top_3_span_top">
	  						<span style="height: 58px;line-height: 58px;">服务器名称：</span><input readonly id="inhostdetailneid" name='nename' style="float: right ;"></input>
	  					</div>
	  				</div>
	  			</div>
	  			<div class = "inhostDetails_space_top_o" style="width: 24%;">
	  				<div class="top_3_span">
		  				<div class="top_3_span_top">
		  					<span style="height: 58px;line-height: 58px;float: left;">IP地址：</span><input readonly id="inhostdetailipaddr" name='ipaddr' style="float: right ;"></input>
		  				</div>
		  			</div>
	  			</div>
	  			<div class = "inhostDetails_space_top_o" style="width: 24%;">
	  				<div class="top_3_span">
	  					<div class="top_3_span_top">
	  						<span style="height: 58px;line-height: 58px;">运维应用：</span><input readonly id="inhostdetailappstat" name='appstat' style="float: right ;color: #ffa300;"></input>
	  					</div>
	  				</div>
	  			</div>
	  			<div class = "inhostDetails_space_top" style="width: 15%;">
	  				<div  class="inhostDetails_space_top_btn" onclick='JumpInHostPage()'>
	  					返回
	  				</div>
	  			</div>
	  		</div>
					...
					<div>
						...
						<article class="ac-smallfive">
							<div class="ac-smallfive_space">
								<table border="1" align="center" style="width:98%" id="hostserviceDetailTable_alarm">
									<thead>
										<tr>
											<th>设备</th>
											<!-- <th>厂商</th>-->
