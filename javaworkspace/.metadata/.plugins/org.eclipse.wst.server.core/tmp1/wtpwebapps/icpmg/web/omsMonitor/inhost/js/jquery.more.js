(function( $ ){          
    ...
    var settings = {
        ...
        'type'           :   '0',
        'onclicktype' :   'all',
        'address'     :   '${pageContext.request.contextPath}/oms_summary/queryInhostList.do',
        'format'      :   'json',
    ...
    var methods = {
        ...
        get_data      : function(){   
           // alert('getting data')
            ...
            var type = $("#hostserviceoverview_searchtype").val();
            var value = $("#hostserviceoverview_searchvalue").val();
            var onclicktypes = $("#inhostonclicktype").val();
             if(type=='1'){
             	variables.last=5;
             	$("#hostserviceoverview_searchtype").val("0");
             }
