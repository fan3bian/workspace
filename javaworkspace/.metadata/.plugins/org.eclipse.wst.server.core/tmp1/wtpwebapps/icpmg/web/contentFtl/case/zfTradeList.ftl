...
<head>
	...
	<script type="text/javascript">
      function pageQuery(page) {
	  	location.href ="politics_"+page+".html";
   	  }
    </script>
<body>
  <#include "../head.html">
			...
			<div class="container-left">
				...
				<ul>
					...
					<ul>
						...
						<li><a class='active' href="politics_1.html">工商行业</a></li>
				...
				<div class="container-cell">
					<div class="inner-case">
						...
						<ul>
							...
							<a href="${"../../case/content/"+"politics_"+customerCase.caseid}.html"><img src="${"../../images/up"+(customerCase.customerlogo)!"/pic-3.jpg"}" style="width: 166px; height: 122px;" alt=""></a>
							<#else>
							<a href="${"../../case/content/"+"politics_"+customerCase.caseid}.html"><img src="../../images/up/pic-3.jpg" style="width: 166px; height: 122px;" alt=""></a>
							</#if>
							</dt>
									<dd>
										<h2><a href="${"../../case/content/"+"politics_"+customerCase.caseid}.html">${customerCase.casetitle}</a></h2>
