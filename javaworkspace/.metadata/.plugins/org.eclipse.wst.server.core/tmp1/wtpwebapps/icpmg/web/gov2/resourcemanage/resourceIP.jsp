...
.ty-top-input{ height: 23px; line-height: 23px; border: none; border-radius: 3px; width: 400px;  padding:0 5px; color: #333;}
            ...
            <div class="ty-tabscon-main">
                ...
                <div class="ty-tabscon-item">
                    ...
                    <div style="height: 300px; overflow:auto;">
                        <table id="internetWindowtt" style="width:692px;height:250px" data-options="fitColumns:true,rownumbers: true,border: false,singleSelect:true,url:'',scrollbarSize:0">
                            <thead>
                                <tr>
                                   <th data-options="field:'application',width:100,formatter:appFormatters,editor:{type: 'combobox'}">
                                   ...
                                   <span class="must-star">*</span>应用</th>
                                    ...
                                    <th data-options="field:'equipmentname',width:180,editor:{type:'combobox'}"> 
  ...
  <script type="text/javascript">
       $.extend($.fn.datagrid.methods, {
         ...
         $('#internetWindowtt').datagrid({
			...
			url:'${pageContext.request.contextPath}/workorder/getoperIPInfo.do?objectid=<%=request.getParameter("objectid")%>',		
              onLoadSuccess: function (data) {
						...
						/* var data = JSON.parse(data); */
						 ...
						 $('#dk').val(data.rows[0].bandwidth);
						  $('#hlwip').val(data.rows[0].outnetip);
